...
import { ArrowLeft, User, Mail, Phone, Briefcase, Users, Building, FileText, Calendar, DollarSign, Clock, Download } from 'lucide-react';
      ...
      submittedCandidates: [
        {
          ...
          history: "Applied → Screening → Technical Round → Interview Scheduled"
        },
        {
          ...
          history: "Applied → Screening → Technical Round → Final Round → Offer Extended"
        },
        {
      ...
      submittedCandidates: [
        {
          ...
          history: "Applied → Executive Screening → Leadership Interview → Final Round"
        }
      ]
    }
  ];
  ...
  const ListView = () => (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Recruiter Management Dashboard</h2>
          <p className="text-gray-600">Manage recruiters and track candidate submissions</p>
        </div>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col space-y-1">
                        ...
                        <div className="text-sm text-gray-600">
                          <span className="font-medium">Positions:</span> {recruiter.positionAssigned}
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex flex-col space-y-1">
                        ...
                        <div className="text-sm text-gray-600">{recruiter.spocToClients}</div>
                        <div className="text-sm text-gray-600">
                          <span className="font-medium">All Clients:</span> {recruiter.clientsRecruitingFor}
                        </div>
                      </div>
                    </td>
                  </tr>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          <div className="flex items-center mb-6">
            ...
            <div className="ml-6">
              <h2 className="text-2xl font-bold text-gray-900">{selectedRecruiter.name}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <div className="flex items-center mb-2">
                ...
                <span className="text-sm font-medium text-gray-700">Position Assigned</span>
              </div>
              <p className="text-gray-900">{selectedRecruiter.positionAssigned}</p>
            </div>

            <div className="bg-gray-50 p-4 rounded-lg">
              <div className="flex items-center mb-2">
                <Users className="h-5 w-5 text-gray-500 mr-3" />
                <span className="text-sm font-medium text-gray-700">SPOC to Clients</span>
              </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg md:col-span-2">
              <div className="flex items-center mb-2">
                ...
                <span className="text-sm font-medium text-gray-700">Clients Recruiting For</span>
              </div>
              <p className="text-gray-900">{selectedRecruiter.clientsRecruitingFor}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            <div className="flex items-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">
                Submitted Candidates ({selectedRecruiter.submittedCandidates.length})
              </h3>
            </div>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {selectedRecruiter.submittedCandidates.map((candidate, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <div className="text-sm font-medium text-gray-900">{candidate.candidate}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
